...
> **📋 存档副本** — 本文档是
> [`pressure_mat_repro`](https://github.com/OVERLORD799/pressure_mat) 的快照
> (Isaac Lab **1.3.0**, 命名空间 `omni.isaac.lab.*`)。
> GMDisturb 项目已迁移至 Isaac Lab **2.x** (`isaaclab.*`)。
> 关于 GMDisturb 自身的架构，请参阅 [`gmdisturb/ARCHITECTURE.md`](../gmdisturb/ARCHITECTURE.md)。

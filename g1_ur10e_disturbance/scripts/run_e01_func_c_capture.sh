...
case "${MODE}" in
  ...
  smoke)
    ...
    python3 "${RUNNER}" \
      ...
      -v "${HOST_GM}/source/GMRobot/GMRobot/assets/container_full_content_visual.usd:/opt/projects/GMRobot/source/GMRobot/GMRobot/assets/container_full_content_visual.usd:ro" \

        ...
        "candidates": [
            {
                ...
                "technical_gate_notes": [
                    ...
                    "left_source_container_visual_corruption_confirmed",
...
def write_docs(
    ...
    review_doc = {
        ...
        "reviewer_approved": False,
        "notes": {
            "func_c": "left source-container visual corruption confirmed in evidence frame; fix pending.",
    ...
    md_lines = [
        ...
        "- Func-C step100/200: left source-container visual corruption confirmed; not clean visual evidence.",

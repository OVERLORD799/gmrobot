...
def test_dockerfile_exists_and_copies_dyn_b_sources():
    ...
    assert "e01-dyn-b-m1u22" in M1U2_IMAGE_TAG
...
def test_canonical_smoke_no_pip_prebundle_and_no_network_models():
    cmd = canonical_dyn_b_smoke_shell(
        output_csv="/opt/projects/g1_ur10e_disturbance/results/paper_demo/v1m1u22_dyn_b_numpy_dedup_smoke_20260723/safety_logs/phase3.csv",
        numpy_origin_pre_json="/opt/projects/g1_ur10e_disturbance/results/paper_demo/v1m1u22_dyn_b_numpy_dedup_smoke_20260723/meta/numpy_origin_pre.json",
        numpy_origin_post_json="/opt/projects/g1_ur10e_disturbance/results/paper_demo/v1m1u22_dyn_b_numpy_dedup_smoke_20260723/meta/numpy_origin_post.json",
    )

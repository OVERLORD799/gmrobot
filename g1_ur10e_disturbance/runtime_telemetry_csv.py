...
RUNTIME_TELEMETRY_FIELDNAMES = [
    ...
    "ur10_arm_joint_delta_max_abs_joint_name",
    "ur10_arm_joint_delta_max_abs_joint_value",
    "ur10_arm_joint_delta_by_name_json",
    "ur10_arm_joint_delta_abs_by_name_json",
    ...
    "ur10_arm_joint_delta_max_abs_settled_joint_name",
    "ur10_arm_joint_delta_max_abs_settled_joint_value",
